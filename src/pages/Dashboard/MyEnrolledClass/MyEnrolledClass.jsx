...
const PaymentHistory = () => {
    ...
    return (
        <div>
            <p className='text-center mb-5 text-3xl text-success font-semiboldtext-center '>Enrolled Class</p>
            <>
                <Helmet>
                    <title>
                        Enrolled Informaion | Sports Exut
                    </title>
                </Helmet>
                {
                    paymenthistory?.length === 0
                        ? <p className='text-white bg-fuchsia-600 w-1/2 mx-auto text-3xl text-center p-5'>No Enrolled Found</p>
                        :
                        <>
                                ...
                                <table className="table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th className='text-lg border border-success text- font-extrabold text-center'>Total Enroled Class</th>
